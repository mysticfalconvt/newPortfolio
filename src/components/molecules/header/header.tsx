    ...
    <header className={styles.header}>
      ...
      {isHome && (
        <p className={styles.description}>
          ...
          project is the school dashboard website that I recently rebuilt from
          the ground up. This project is a full-stack web application that
          allows teachers, students, and parents to manage everything about
          their school experience. The{" "}
          <code className={styles.code}>Front-End</code> is built with React,
          Next.js, Styled Components, React-Query, and Chart.js. The{" "}
